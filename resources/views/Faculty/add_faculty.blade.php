...
<div class="content mt-3">
    <div class="animated fadeIn">
        ...
        <form method="POST" class="jotform-form" action="/add_facultyaction"  enctype="multipart/form-data">
          ...
          <li class="form-line" data-type="control_textbox" id="id_28">
            ...
            <div id="cid_28" class="form-input">
              <span class="form-sub-label-container" style="vertical-align:top">
                <input type="file" name="profile_faculty" required>
              ...
              <li class="form-line" data-type="control_textbox" id="id_28">
                ...
                <div id="cid_28" class="form-input">
                   <span class="form-sub-label-container" style="vertical-align:top">
                      <select name="role" id="input_24_day" class="form-dropdown" data-component="birthdate-day" aria-labelledby="label_24 sublabel_24_day">
                        <option>  </option>
