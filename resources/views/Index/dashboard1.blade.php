...
<link href="{{asset('assets/css/formcss.css')}}" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="{{asset('assets/css/nova.css')}}" />
...
<style type="text/css">
    ...
    .supernova{
        ...
        background-image: url("{{asset('images/form_background.jpg')}}");
    }
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/index') }}"><img src="{{asset('logo.png')}}" height="40px" width="40px" alt="Logo" align="Left">&nbsp&nbsp&nbsp&nbsp&nbspAAMS</a>
